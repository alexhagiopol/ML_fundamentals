function J = computeCost(X, y, theta)
	...
	% N.B.
	% 1. X is an mx2 matrix whose first column contains all 1s to be multiplied with the theta_0 intercept term and 
	% whose last column contains the actual input data values.

function J = computeCostMulti(X, y, theta)
	...
	% N.B.
	% 1. X is an mx(n+1) matrix whose first column contains all 1s to be multiplied with the theta_0 intercept term 
	% whose final n columns contain the actual input data values.
